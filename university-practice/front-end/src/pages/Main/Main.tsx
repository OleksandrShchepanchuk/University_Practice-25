...
const featuredMovie = {
    ...
    description: 'Коли садистський серійний вбивця починає вбивати ключових політичних фігур у Ґотемі...',
            ...
            <div className={styles.page}>
                ...
                >
                    <div className={styles.overlay}>
                        <img src={featuredMovie.poster} alt={featuredMovie.title} className={styles.poster} />
